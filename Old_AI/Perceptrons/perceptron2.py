...
def gen_new(old, mut_mag, mut_num, mut_k):
    new_gen = list()
...
def chal_5():
    ...
    while avg_acc < .99:
        ...
        current_gen = gen_new(current_gen, volatility[0], volatility[1], volatility[2])
